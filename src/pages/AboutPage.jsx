  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12 space-y-16">
      ...
      <div className="text-center space-y-4">
        ...
        <h1 className="font-cinzel text-4xl sm:text-5xl font-bold text-ivory">The Story of KATHRAZ</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div className="relative aspect-square rounded-2xl overflow-hidden border border-gold/30 shadow-2xl">
          ...
          <div className="absolute bottom-6 left-6 right-6 text-xs text-gold font-cinzel tracking-wider">
            HAND-BOTTLED & SEALED IN INDIA
          </div>
        </div>

        <div className="space-y-6 text-xs text-ivory/80 font-light leading-relaxed">
          <h2 className="font-cinzel text-2xl font-bold text-ivory">Centuries of Incense & Gold</h2>
          <p>
          ...
          <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gold/15">
            <div className="space-y-1">
              <span className="font-cinzel text-xl font-bold text-gold block">35%</span>
              <span className="text-muted text-[10px] uppercase">Extrait Concentration</span>
            </div>
            <div className="space-y-1">
              <span className="font-cinzel text-xl font-bold text-gold block">100%</span>
